...
symbols_: {
  ...
  "error": 2,
  "identifier_list": 26,
  "specifier_qualifier_list": 27,
  "struct": 23,
  "struct_declarator": 25,
  "struct_declarator_list": 24,
  "type_qualifier": 29,
  "type_specifier": 28,
  "{": 3,
  "}": 4
...
case 1:
    /*! Production::    struct : %epsilon */
case 5:
    /*! Production::    struct_declarator : %epsilon */
...
case 2:
    /*! Production::    struct : STRUCT IDENTIFIER "{" struct_declarator_list "}" ";" */

    this.$ = Array.from(new Set(yyvstack[yysp - 2]));
    break;
...
case 6:
    /*! Production::    struct_declarator : identifier_list ";" */

    if (yyvstack[yysp - 1].length >= 1) {
        this.$ = yyvstack[yysp - 1][0];
    } else {
        this.$ = null;
    }
    break;
...
case 8:
    /*! Production::    identifier_list : specifier_qualifier_list identifier_list */
case 9:
    /*! Production::    identifier_list : STRUCT identifier_list */
case 10:
    /*! Production::    identifier_list : BUILTIN identifier_list */
case 13:
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = structTypes;
  exports.Parser = structTypes.Parser;
